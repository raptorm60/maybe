...
class Family::AutoMerchantDetectorTest < ActiveSupport::TestCase
  ...
  test "auto detects transaction merchants" do
    ...
    assert_equal "https://finnhub.io/api/logo?symbol=MCD", txn1.reload.merchant.logo_url
    assert_equal "https://finnhub.io/api/logo?symbol=CMG", txn2.reload.merchant.logo_url
